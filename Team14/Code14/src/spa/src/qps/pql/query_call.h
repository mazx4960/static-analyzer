...
class QueryCall {
 protected:
  ...
  SynonymDeclaration *query_declaration_;

  std::vector<QueryClause *> clause_vector_;

 public:
  QueryCall(CallType call_type, SynonymDeclaration *query_declaration, std::vector<QueryClause *> clause_vector)
      : type_(call_type),
  ...
  [[nodiscard]] SynonymDeclaration * getDeclaration() const;
...
class SelectCall : public QueryCall {
 public:
  SelectCall(SynonymDeclaration *query_declaration, std::vector<QueryClause *> clause_vector)
