...
class QueryKeywords {
 private:
  ...
  inline static const std::unordered_set<std::string> kSuchThatKeywords{"such", "that"};

  inline static const std::unordered_set<std::string> kAndKeywords{"and"};

  inline static const std::unordered_set<std::string> kSpecialSynonymKeywords{"BOOLEAN"};

  inline static const std::unordered_map<std::string, EntityType> kDeclarationKeywordsMap
      {{"stmt", EntityType::kStatement}, {"read", EntityType::kReadStmt}, {"print", EntityType::kPrintStmt},
       {"call", EntityType::kCallStmt}, {"while", EntityType::kWhileStmt}, {"if", EntityType::kIfStmt},
       {"assign", EntityType::kAssignStmt}, {"variable", EntityType::kVariable}, {"constant", EntityType::kConstant},
       {"procedure", EntityType::kProcedure}};

  inline static const std::unordered_map<std::string, RsType> kRelationshipKeywordsMap
      {{"Follows", RsType::kFollows}, {"Follows*", RsType::kFollowsT}, {"Parent", RsType::kParent},
       {"Parent*", RsType::kParentT}, {"Uses", RsType::kUses}, {"Modifies", RsType::kModifies},
       {"Calls", RsType::kCalls}, {"Calls*", RsType::kCallsT}, {"Next", RsType::kNext}, {"Next*", RsType::kNextT},
       {"Affects", RsType::kAffects}, {"Affects*", RsType::kAffectsT}, {"pattern", RsType::kAssignPattern}};

  inline static const std::unordered_map<std::string, AttributeType> kAttributeKeywordsMap
      {{"procName", AttributeType::kProcName}, {"varName", AttributeType::kVarName}, {"value", AttributeType::kValue},
       {"stmt#", AttributeType::kStmtNo}};

  inline static const std::unordered_map<std::string, RsType> kPatternKeywordsMap{{"pattern", RsType::kAssignPattern}};
 ...
 public:
  ...
  static bool isValidWithKeyword(const std::string &keyword);
