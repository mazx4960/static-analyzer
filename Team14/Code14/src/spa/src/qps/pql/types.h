...
inline std::string SelectTypeToString(SelectType type) {
  switch (type) {
    case SelectType::kElem:return "Elem";
    case SelectType::kBoolean:return "Boolean";
...
inline std::string RefTypeToString(ReferenceType type) {
  switch (type) {
    case ReferenceType::kSynonym:return "Synonym";
    case ReferenceType::kWildcard:return "Wildcard";
    case ReferenceType::kInteger:return "Integer";
    case ReferenceType::kIdent:return "Ident";
    case ReferenceType::kAttr:return "Attr";
    default:return "Unknown";
  }
}
...
inline ReferenceType AttrToRefType(AttributeType type) {
  switch (type) {
    ...
    case AttributeType::kVarName:return ReferenceType::kIdent;
    case AttributeType::kValue:
    case AttributeType::kStmtNo:return ReferenceType::kInteger;
    default:return ReferenceType::kWildcard;
  }
}
