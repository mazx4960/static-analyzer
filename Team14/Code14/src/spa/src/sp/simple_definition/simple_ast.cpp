...
std::vector<Node *> ProgramNode::GetChildren() {
  return std::vector<Node *>(procedures_.begin(), procedures_.end());
}
...
std::vector<Node *> ProcedureNode::GetChildren() {
  return std::vector<Node *>{statementList_};
}
...
EntityType StatementNode::GetStmtType() {
...
std::vector<Node *> ReadNode::GetChildren() {
  return std::vector<Node *>{variable_};
}
...
std::vector<Node *> PrintNode::GetChildren() {
  return std::vector<Node *>{variable_};
}
...
std::vector<Node *> CallNode::GetChildren() {
...
CondExprNode *WhileNode::GetConditional() {
...
std::vector<Node *> WhileNode::GetChildren() {
  return std::vector<Node *>{conditional_, statementList_};
}
...
CondExprNode *IfNode::GetConditional() {
  return this->conditional_;
}
...
std::vector<Node *> AssignNode::GetChildren() {
  return std::vector<Node *>{variable_, expression_};
}
VariableNode *AssignNode::GetVariable() {
  return this->variable_;
}
RelFactorNode *AssignNode::GetExpression() {
...
CondExprType CondExprNode::GetCondExprType() {
  return cond_expr_type_;
}
...
std::vector<Node *> NotExprNode::GetChildren() {
  return std::vector<Node *>{negatedConditional_};
}
...
std::vector<Node *> RelExprNode::GetChildren() {
  return std::vector<Node *>{leftFactor_, rightFactor_};
}
