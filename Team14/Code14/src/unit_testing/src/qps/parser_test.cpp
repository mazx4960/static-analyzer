...
//  auto *expected = new ElemSelect(new SynonymReference(new QuerySynonym("v")));
//  QueryParser parser = QueryParser(tokens);
...
//  QueryParser parser = QueryParser(tokens);
//  auto declarations = parser.ParseDeclaration();
...
//  std::vector<Token *> tokens =
//      {new SymbolToken("with"), new SymbolToken("s"), new DotToken(), new SymbolToken("stmt"), new HashtagToken(),
//       new ComparatorToken("="), new LiteralToken("1"), new EndOfFileToken()};
...
//  std::vector<Token *> tokens =
//      {new SymbolToken("with"), new SymbolToken("s"), new DotToken(), new SymbolToken("stmt"), new HashtagToken(),
//       new ComparatorToken("="), new LiteralToken("1"), new SymbolToken("and"), new SymbolToken("s"), new DotToken(),
//       new SymbolToken("procName"), new ComparatorToken("="), new QuoteToken(), new SymbolToken("proc"),
