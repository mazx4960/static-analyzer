...
TEST(PopulatePatternTest, SingleStatementTest) {
  ...
  std::string expr1 = "x + 1";
  std::string expr2 = "y + 1";
  std::string expr3 = "x + 1 + y + 1";
  ...
  bool compare = PKBTestHelper::set_pair_compare(pattern_table->Get(v), expected);
...
TEST(PopulatePatternTest, RepeatedVariableTest) {
  ...
  auto *v = new VariableEntity("v");
  std::string expr1 = "x + 1";
  std::string expr2 = "y + 2";
  std::string expr3 = "z + 3";
  EntityStringPairUnorderedSet expected;
  std::vector<Pattern *> patterns({
...
TEST(PopulatePatternTest, RepeatedExpressionTest) {
  ...
  pattern_manager->Populate(patterns);
  auto *pattern_table = pattern_manager->GetTable();
  bool compare_v1 = PKBTestHelper::set_pair_compare(pattern_table->Get(v1), expected_v1);
  bool compare_v2 = PKBTestHelper::set_pair_compare(pattern_table->Get(v2), expected_v2);
  bool compare_v3 = PKBTestHelper::set_pair_compare(pattern_table->Get(v3), expected_v3);
  bool compare_v4 = PKBTestHelper::set_pair_compare(pattern_table->Get(v4), expected_v4);
