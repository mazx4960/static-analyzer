...
TEST(StatementTypeHashTest, EqualAssign) {
  auto *s1 = new StatementEntity(StmtType::kAssign, 123);
  auto *s2 = new StatementEntity(StmtType::kAssign, 123);
  ASSERT_EQ(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, EqualCall) {
  auto *s1 = new StatementEntity(StmtType::kCall, 123);
  auto *s2 = new StatementEntity(StmtType::kCall, 123);
  ASSERT_EQ(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, EqualIf) {
  auto *s1 = new StatementEntity(StmtType::kIf, 123);
  auto *s2 = new StatementEntity(StmtType::kIf, 123);
  ASSERT_EQ(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, EqualWhile) {
  auto *s1 = new StatementEntity(StmtType::kWhile, 123);
  auto *s2 = new StatementEntity(StmtType::kWhile, 123);
  ASSERT_EQ(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, EqualPrint) {
  auto *s1 = new StatementEntity(StmtType::kPrint, 123);
  auto *s2 = new StatementEntity(StmtType::kPrint, 123);
  ASSERT_EQ(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, EqualRead) {
  auto *s1 = new StatementEntity(StmtType::kRead, 123);
  auto *s2 = new StatementEntity(StmtType::kRead, 123);
  ASSERT_EQ(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
...
TEST(StatementTypeHashTest, UnequalAssign) {
  auto *s1 = new StatementEntity(StmtType::kAssign, 123);
  auto *s2 = new StatementEntity(StmtType::kAssign, 234);
  ASSERT_NE(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, UnequalCall) {
  auto *s1 = new StatementEntity(StmtType::kCall, 123);
  auto *s2 = new StatementEntity(StmtType::kCall, 234);
  ASSERT_NE(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, UnequalIf) {
  auto *s1 = new StatementEntity(StmtType::kIf, 123);
  auto *s2 = new StatementEntity(StmtType::kIf, 234);
  ASSERT_NE(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, UnequalWhile) {
  auto *s1 = new StatementEntity(StmtType::kWhile, 123);
  auto *s2 = new StatementEntity(StmtType::kWhile, 234);
  ASSERT_NE(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, UnequalPrint) {
  auto *s1 = new StatementEntity(StmtType::kPrint, 123);
  auto *s2 = new StatementEntity(StmtType::kPrint, 234);
  ASSERT_NE(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
TEST(StatementTypeHashTest, UnequalRead) {
  auto *s1 = new StatementEntity(StmtType::kRead, 123);
  auto *s2 = new StatementEntity(StmtType::kRead, 234);
  ASSERT_NE(EntityHashFunction().operator()(s1), EntityHashFunction().operator()(s2));
}
...
TEST(StatementTypeHashTest, AssignCall) {
  auto *s1 = new StatementEntity(StmtType::kAssign, 123);
  auto *s2 = new StatementEntity(StmtType::kCall, 123);
  auto *s3 = new StatementEntity(StmtType::kIf, 123);
  auto *s4 = new StatementEntity(StmtType::kWhile, 123);
  auto *s5 = new StatementEntity(StmtType::kPrint, 123);
  auto *s6 = new StatementEntity(StmtType::kRead, 123);
  std::unordered_set<size_t> set = {
